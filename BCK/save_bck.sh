...
cp -r $LUX_DIR/data/individual_features $LUX_DIR/data/bck_best/
...
setup=$(sed -rn '$ s/(.*)EPOCH:\s(\[.*\])\sAVG(.*)$/\2/p' $LUX_DIR/results.txt)
...
sed -r -i "s/^(SETUP:\s)(.*)/\1$setup/" $LUX_DIR/data/bck_best/README.md
